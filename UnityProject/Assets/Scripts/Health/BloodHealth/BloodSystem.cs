...
public class BloodSystem : MonoBehaviour
{
    ...
    {
        get {
            return Mathf.Clamp(toxinLevel, 0, 101);
        }
        set {
            toxinLevel = Mathf.Clamp(value, 0, 101);
        }
    }
    ...
    {
        get {
            return Mathf.Clamp(oxygenDamage, 0, 200);
        }
        set {
            oxygenDamage = Mathf.Clamp(value, 0, 200);
        }
    }
    /// <summary>
